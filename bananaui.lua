...
-- [FIXED - theo yêu cầu boss man: "ko dùng ui redz của vanta nha"]
-- Toàn bộ phần load UI + tạo Window/Tabs bên dưới đã đổi từ redzlib sang
-- Fluent (UI gốc của longhihi Hub). Mọi TÍNH NĂNG/CALLBACK bên dưới (toàn bộ
-- ~450 toggle/dropdown/slider/button của vantablack) được giữ NGUYÊN VẸN
-- — chỉ có phần vỏ UI đổi thư viện.
local Fluent

local fluentOk = pcall(function()
    Fluent = loadstring(game:HttpGet(
        "https://pastefy.app/uccNZACu/raw"
    ))()
end)
...
if not Fluent then
    pcall(function()
        game.StarterGui:SetCore("SendNotification", {
            Title = "longhihi", Text = "Fluent load thất bại! Kiểm tra executor.", Duration = 10
        })
    end)
    return
end

-- SaveManager/InterfaceManager removed — using Tab #2 style save/load instead

local Window = Fluent:CreateWindow({
    Title = "Longhihi Evolution x",
    SubTitle = "Blox Fruits",
    TabWidth = 155,
    Size = UDim2.fromOffset(425, 375),
    Acrylic = true,
    Theme = "Liquid Glass",
...
local Tabs = {
    Info = Window:AddTab({ Title = "Info And Status", Icon = "info" }),
    Main = Window:AddTab({ Title = "Farming", Icon = "zap" }),
    Hop = Window:AddTab({ Title = "Hop Server [Beta]", Icon = "locate" }),
    Settings = Window:AddTab({ Title = "Setting", Icon = "settings" }),
    Fish = Window:AddTab({ Title = "Fishing", Icon = "anchor" }),
    Quests = Window:AddTab({ Title = "Quest And Item", Icon = "list" }),
    SeaEvent = Window:AddTab({ Title = "Sea Event", Icon = "ship" }),
    Race = Window:AddTab({ Title = "Mirage And Race", Icon = "flag" }),
    Prehistoric = Window:AddTab({ Title = "Volcano Event", Icon = "flame" }),
    Esp = Window:AddTab({ Title = "Stats And Esp", Icon = "bar-chart-3" }),
    Raids = Window:AddTab({ Title = "Dungeon / Raiding", Icon = "swords" }),
    Combat = Window:AddTab({ Title = "Local Player", Icon = "shield" }),
    Travel = Window:AddTab({ Title = "Teleport", Icon = "map-pin" }),
    Shop = Window:AddTab({ Title = "Shopping", Icon = "shopping-cart" }),
    Misc = Window:AddTab({ Title = "Miscellaneous", Icon = "more-horizontal" }),
    Music = Window:AddTab({ Title = "Music Player", Icon = "music" })
}
...
Tabs.Hop:AddParagraph({Title = "And Another longhihi hub Script", Content = ""})
do
    Tabs.Hop:AddButton({
...
Tabs.Info:AddParagraph({Title = "Information", Content = ""})
...
Tabs.Info:AddParagraph({Title = "Status Server", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farming", Content = ""})
...
-- ============================================================
Tabs.Main:AddParagraph({Title = "─── Status: Cake Prince ───", Content = ""})
...
-- ============================================================
Tabs.Main:AddParagraph({Title = "─── Status: Tyrant of the Skies ───", Content = ""})
...
-- ============================================================
Tabs.Main:AddParagraph({Title = "─── Status: Farm Bone ───", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Event Dog House [ BETA ]", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Chest", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Collect Berry", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farm Mob", Content = ""})
if World1 then
    do
...
Tabs.Main:AddParagraph({Title = "Farm All Island", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farm Elite Hunter", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farm Rip Indra", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farming Cake", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farming Bone", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Tyrant of the Skies", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farm Material", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farm Boss", Content = ""})
...
Tabs.Main:AddParagraph({Title = "Farming Mastery", Content = ""})
...
Tabs.Settings:AddParagraph({Title = "Settings / Configure", Content = ""})
...
Tabs.Esp:AddParagraph({Title = "Stats Upgrade", Content = ""})
...
Tabs.Fish:AddParagraph({Title = "Fishing", Content = ""})
...
Tabs.Quests:AddParagraph({Title = "Tushita + Yama", Content = ""})
...
Tabs.Quests:AddParagraph({Title = "Skull Guitars / Misc", Content = ""})
...
Tabs.Quests:AddParagraph({Title = "Cursed Dual Katana", Content = ""})
...
Tabs.Quests:AddParagraph({Title = "True Triple Katana Sword", Content = ""})
do
...
Tabs.Quests:AddParagraph({Title = "Pole / God Enal's", Content = ""})
do
...
Tabs.Quests:AddParagraph({Title = "Rengoku Sword", Content = ""})
do
...
Tabs.Quests:AddParagraph({Title = "Cavender + Twin Hooks + Bigmom", Content = ""})
do
...
Tabs.Quests:AddParagraph({Title = "Buso/Aura Colours", Content = ""})
do
...
Tabs.Quests:AddParagraph({Title = "Instinct / Observation", Content = ""})
do
...
Tabs.Quests:AddParagraph({Title = "Fighting Melee Styles", Content = ""})
do
...
Tabs.Race:AddParagraph({Title = "Mystic Island / Full Moon", Content = ""})
...
Tabs.Race:AddParagraph({Title = "Upgrade Races V2 And V3", Content = ""})
do
...
Tabs.Race:AddParagraph({Title = "Trials Quest V4", Content = ""})
...
Tabs.Prehistoric:AddParagraph({Title = "Dojo Quest", Content = ""})
do
...
Tabs.Prehistoric:AddParagraph({Title = "Drago Trial", Content = ""})
...
Tabs.Prehistoric:AddParagraph({Title = "Volcanic Crafting", Content = ""})
...
Tabs.Prehistoric:AddParagraph({Title = "Prehistoric Island", Content = ""})
...
Tabs.SeaEvent:AddParagraph({Title = "Sea Event / Setting Sail", Content = ""})
...
Tabs.SeaEvent:AddParagraph({Title = "Crafting Items", Content = ""})
...
Tabs.SeaEvent:AddParagraph({Title = "Choose Sea Event", Content = ""})
...
Tabs.SeaEvent:AddParagraph({Title = "Entity Sea Event", Content = ""})
...
Tabs.SeaEvent:AddParagraph({Title = "Kitsune Island / Event", Content = ""})
...
Tabs.SeaEvent:AddParagraph({Title = "Frozen Dimension Event", Content = ""})
...
Tabs.Esp:AddParagraph({Title = "Esp", Content = ""})
...
Tabs.Raids:AddParagraph({Title = "Fruits Options", Content = ""})
...
Tabs.Raids:AddParagraph({Title = "Dungeon Settings", Content = ""})
...
-- ============================================================
Tabs.Raids:AddParagraph({Title = "Raid Settings", Content = ""})
...
Tabs.Raids:AddParagraph({Title = "Items Law/Order Sword", Content = ""})
Tabs.Combat:AddParagraph({Title = "Combat / AimBot", Content = ""})
...
Tabs.Combat:AddParagraph({Title = "Quests Players", Content = ""})
...
Tabs.Combat:AddParagraph({Title = "LocalPlayer Settings", Content = ""})
...
Tabs.Travel:AddParagraph({Title = "Travel - Worlds", Content = ""})
...
Tabs.Travel:AddParagraph({Title = "Travel - Island", Content = ""})
Location = {}
for i,v in pairs(workspace["_WorldOrigin"].Locations:GetChildren()) do  
...
Tabs.Travel:AddParagraph({Title = "Travel - Portal", Content = ""})
if World1 then
  Location_Portal = {
    "Sky",
    "UnderWater"
...
Tabs.Travel:AddParagraph({Title = "Travel - NPCs", Content = ""})
...
Tabs.Shop:AddParagraph({Title = "Shop Options", Content = ""})
do
    Tabs.Shop:AddButton({
    Title =  "Buy Buso",
...
Tabs.Shop:AddParagraph({Title = "Fighting - Styler", Content = ""})
...
Tabs.Shop:AddParagraph({Title = "Accessory", Content = ""})
do
    Tabs.Shop:AddButton({
...
Tabs.Shop:AddParagraph({Title = "Weapon World1", Content = ""})
do
    Tabs.Shop:AddButton({
    Title =  "Buy Cutlass",
...
Tabs.Shop:AddParagraph({Title = "Fragments shop", Content = ""})
do
    Tabs.Shop:AddButton({
...
Tabs.Misc:AddParagraph({Title = "Server - Function", Content = ""})
do
    Tabs.Misc:AddButton({
...
Tabs.Misc:AddParagraph({Title = "Player Gui / Others", Content = ""})
...
Tabs.Misc:AddParagraph({Title = "Graphics / Haki Stats", Content = ""})
...
Tabs.Misc:AddParagraph({Title = "Configure - God", Content = ""})
do
    Tabs.Misc:AddButton({
...
-- ── UI: Music tab ──────────────────────────────
Tabs.Music:AddParagraph({Title = "🎵Music Player", Content = ""})
